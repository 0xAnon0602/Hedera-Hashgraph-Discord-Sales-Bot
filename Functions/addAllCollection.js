...
const addAllCollectionFunction = async(_interaction) => {
    ...
    try{
        ...
        if(channelAlreadyExists == true && allCollection == false){
        ...
        await updateContracts(
            ...
            {
                $set:{"contracts":[],"allCollection":1}
            }
        )

        var exampleEmbed = new MessageEmbed()
        .setColor('#00ff00')
        .setDescription(`All contracts are added!`)     
        ...
        if(channelAlreadyExists == true && allCollection==true){
            var exampleEmbed = new MessageEmbed()
            .setColor('#00ff00')
...
module.exports = addAllCollectionFunction
